...
function capacityIsValid(req, _res, next) {
...
function tableCapacityIsLargeEnough(_req, res, next) {
...
module.exports = {
  ...
  delete: [asyncErrorBoundary(tableExists()), asyncErrorBoundary(finishTable)],
